...
public enum LikeErrorCode implements ErrorCode {
    ...
    REVIEW_NOT_LIKED(400, "Like_02", "좋아요한 리뷰가 아닙니다."),
    LIKE_NOT_FOUND_IN_MEMBER(400, "Like_03", "멤버의 좋아요 리스트에 해당 좋아요가 없습니다."),
    LIKE_NOT_FOUND_IN_REVIEW(400, "Like_04", "리뷰에 해당 좋아요가 없습니다."),

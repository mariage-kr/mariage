...
public enum DrinkLowerCategory {
    ...
    KAOLIANG_LIQUOR(13, "고량주", FOREIGN_SPIRITS),
    ...
    MALT_WHISKY(24, "몰트 위스키", FOREIGN_WHISKEY),
    BLENDED_WHISKEY(25, "블렌디드 위스키", FOREIGN_WHISKEY),
    GRAIN_WHISKY(26, "그레인 위스키", FOREIGN_WHISKEY),
    SCOTCH_WHISKY(27, "스카치 위스키", FOREIGN_WHISKEY),
    IRISH_WHISKEY(28, "아이리쉬 위스키", FOREIGN_WHISKEY),

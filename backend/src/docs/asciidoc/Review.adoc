...
include::{snippets}/Review/FindReviews/Member/Write/http-request.adoc[]
...
include::{snippets}/Review/FindReviews/Member/Write/http-response.adoc[]

==== Fields

include::{snippets}/Review/FindReviews/Member/Write/response-fields.adoc[]